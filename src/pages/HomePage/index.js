    ...
    return(
      ...
      <div className="home-page">
        ...
        <div className="main-page-container">
          ...
          <p>People use Wassaly because it's safe and affordable to price and ship you stuff, We offer our customers the chance to save money, reduce strees and provide relevant trusted transport </p>
          <h2>Mission</h2>
